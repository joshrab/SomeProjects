...
public class PhysicsDraft {
  ...
  private void double freeFallResults () {
    ...
    if (!totalTime.equals("NA")) double halfTripTime = Double.parseDouble(totalTime)/2;
    ...
    if (initalVelocity.equals("NA")) {
      ...
      if (!totalTime.equals("NA") && !maxHeight.equals("NA")) initial velocity = ((Double.parseDouble(maxHeight)/(4.9 * halfTripTime * halfTripTime))/halfTripTime;
    }
